...
transport = paramiko.Transport(("192.168.0.103", 22))    # 获取Transport实例
...
sftp.put("/home/liyuan3970/ML_pred_station_max_wind/progress_v3/upload/"+str(year)+str(month)+str(day)+".nc", '/home/liyuan3970/lhm/'+'ZJGRID.331000'+'.'+str(year)+str(month)+str(day_now)+'20'+'.'+'Wind03'+'.nc')
